...
data_root = 'data/mscoco_debug/'
train_root = 'data/mscoco_debug/train/'
val_root = 'data/mscoco_debug/val/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/mscoco_debug/train/label_fullbody.txt',
        img_prefix='data/mscoco_debug/train/images/',
        pipeline=[
    ...
    val=dict(
        type='RetinaFaceDataset',
        ann_file='data/mscoco_debug/val/label_fullbody.txt',
        img_prefix='data/mscoco_debug/val/images/',
        pipeline=[
